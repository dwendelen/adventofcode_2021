...
(def initial-box [[-50 51] [-50 51] [-50 51]])

(let [ [_ x1] (cut-across space-after-input 0 -50)
       [x2 _] (cut-across x1 0 51)
       [_ y1] (cut-across x2 1 -51)
       [y2 _] (cut-across y1 1 51)
       [_ z1] (cut-across y2 2 -50)
       [z2 _] (cut-across z1 2 51)
     ]
  (println (num-on z2 initial-box))
)
